      ...
      {isGuest && (
        <div className="flex flex-col items-center justify-center text-center py-12 sm:py-16">
          ...
          <div className="flex flex-col items-center gap-3 w-full sm:w-auto">
            ...
            <Link
              to="/catalog"
              className="inline-flex items-center justify-center px-8 py-3.5 bg-surface-white border border-brand-outline text-brand-outline text-[15px] font-medium rounded-radius-md hover:bg-surface-cream transition-colors no-underline"
            >
